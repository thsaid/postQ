...
```{r}
SALESfit <- cfa(latents.model,data = SALES, ordered= TRUE, estimator = "DWLS") #ordered = true means that the variables are ordered categoricals
summary (SALESfit, fit.measrues = TRUE) #to view summary of the fit
